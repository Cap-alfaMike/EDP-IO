...
class TestLogAnalyzer:
    ...
    def test_log_analyzer_categorizes_errors(self, mock_settings):
        ...
        from src.observability.log_analyzer import LogAnalyzer, ErrorType
...
class TestSchemaDriftDetector:
    ...
    def test_detect_column_added(self, sample_schema_expected, sample_schema_actual, mock_settings):
        ...
        from src.observability.schema_drift import SchemaDriftDetector, ChangeType
    ...
    def test_detect_column_removed(self, mock_settings):
        ...
        from src.observability.schema_drift import SchemaDriftDetector, SchemaColumn, ChangeType
    ...
    def test_detect_type_change(self, mock_settings):
    ...
    def test_no_drift_detected(self, mock_settings):
        ...
        from src.observability.schema_drift import SchemaDriftDetector, SchemaColumn, DriftSeverity
